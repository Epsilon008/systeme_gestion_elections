      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 mb-8">
          <div className="relative">
            ...
            <input
              type="text"
              placeholder="Rechercher un enrolleur..."
        ...
        <AnimatePresence>
          {showForm && (
            ...
            >
              <h2 className="text-xl font-semibold mb-6">Ajouter un nouvel enrolleur</h2>
        ...
        <AnimatePresence>
          {showCredentials && newEnrollerCredentials && (
            ...
            >
              ...
              >
                <h3 className="text-xl font-semibold mb-4">Identifiants de l'enrolleur</h3>
        ...
        {filteredEnrollers.length === 0 && (
          <div className="text-center py-12">
            ...
            >
              ...
              <h3 className="text-lg font-medium text-gray-900 mb-2">Aucun enrolleur trouvé</h3>
              <p className="text-gray-500">
                Ajoutez un nouvel enrolleur pour commencer
              </p>
            </motion.div>
          </div>
        )}
